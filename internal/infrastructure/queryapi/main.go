...
func LoadAiModel() (l *llama.LLama) {
	...
	l, err = llama.New("/home/atorres/Dev/Go/ecatrom2000/models/llama-2-7b-chat.ggmlv3.q4_0.bin", llama.EnableF16Memory, llama.SetContext(2048), llama.SetGPULayers(0))
	if err != nil {
